...
pub const ADDRESS: std::net::Ipv4Addr = std::net::Ipv4Addr::new(192, 168, 0, 150);
pub const PORT: u16 = 7777;
pub const RSA_KEY_SIZE: u32 = 1 << 11;  // 2 ^ 11 == 2048, must be greater than 2 ^ 8
pub const AES_KEY_SIZE: usize = 1 << 7;   // 2 ^ 8 == 256, can be 128, 192 or 256

pub const NUMBERS_TO_SEND: usize = 3;
